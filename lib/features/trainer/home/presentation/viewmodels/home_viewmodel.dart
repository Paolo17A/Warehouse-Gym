...
import 'package:the_warehouse_gym/features/trainer/home/presentation/viewmodels/home_state.dart';
...
class HomeViewModel extends StateNotifier<HomeState> {
  ...
  HomeViewModel({required TrainerAccountUseCase account})
      : _account = account,
...
final homeViewModelProvider =
  ...
  return HomeViewModel(account: sl<TrainerAccountUseCase>());
});
